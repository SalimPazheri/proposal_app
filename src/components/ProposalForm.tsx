...
export default function ProposalForm({ onSuccess, editingProposal }: ProposalFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    free_time_loading: '4 Hrs',
    free_time_origin_border: '4 Hrs',
    free_time_destination_border: '4 Hrs',
    detention_charges: '',
    payment_terms: '',
    validity: '',
    notes: '',
  ...
  useEffect(() => {
    if (editingProposal) {
      setFormData({
        ...
        free_time_loading: editingProposal.free_time_loading || '4 Hrs',
        free_time_origin_border: editingProposal.free_time_origin_border || '4 Hrs',
        free_time_destination_border: editingProposal.free_time_destination_border || '4 Hrs',
